    ...
    try {
      ...
      if (audio_enabled && !video_enabled) {
        ...
        const video_stream_constraints = {
          frameRate: { exact: info.type.video.framerate },
          width: { exact: info.type.video.width },
          height: { exact: info.type.video.height }
        };
        ...
        throw new Error("Audio & video mode is currently not supported");
      }
    } catch (error) {
