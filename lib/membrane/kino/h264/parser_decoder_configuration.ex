defmodule Membrane.Kino.H264.Parser.DecoderConfiguration do
  @moduledoc """
  ...
  @doc """
  Converts decoder configuration to avc1 format (for example "avc1.64002a").
  """
  @spec to_avc1(t()) :: binary()
  def to_avc1(config) do
    "avc1." <>
      Base.encode16(
        <<config.avc_profile_indication, config.profile_compatibility, config.avc_level>>
      )
  end
end
